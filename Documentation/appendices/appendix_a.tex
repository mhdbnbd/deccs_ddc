\chapter{Appendix A: Hyperparameter Optimization}
...
\begin{table}[H]
    \centering
    \caption{Performance variance across random seeds}
    \label{tab:seed_variance}
    \begin{tabular}{ccccc}
        \hline
        \textbf{Seed} & \textbf{NMI} & \textbf{ARI} & \textbf{ACC} & \textbf{Silhouette} \\
        \hline
        ...
        \hline
        \textbf{Mean} & \textbf{0.751} & \textbf{0.592} & \textbf{0.693} & \textbf{0.429} \\
        \textbf{Std} & \textbf{0.003} & \textbf{0.003} & \textbf{0.003} & \textbf{0.003} \\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    \centering
    \caption{Training time per epoch for different configurations}
    \label{tab:timing}
    \begin{tabular}{ccc}
        \hline
        \textbf{Configuration} & \textbf{Time/Epoch (s)} & \textbf{Total (10 epochs)} \\
        \hline
